...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-4">Pilih Portal</h1>
        <hr class="my-4">
        <a class="btn btn-warning btn-lg" href="tendik_login.php" role="button">Tenaga Pendidik</a>
        <a class="btn btn-warning btn-lg" href="siswa_login.php" role="button">Siswa</a>
      </div>
    </div>
