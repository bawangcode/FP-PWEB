...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron" style="height: 100vh; margin-bottom: 0;">
      <div class="container">
        <h1 class="display-4">Portal Tenaga Pendidik</h1>
        <p class="lead">Tugas menugas menjadi mudah bersama Bawagn!</p>
        <hr class="my-4">
        <p>Anda masuk sebagai tenaga pendidik! berikut opsi yang tersedia untuk anda.</p>
        <a class="btn btn-warning btn-lg" href="tendik_readtugas.php" role="button">Lihat Tugas</a>
      </div>
    </div>
